    ...
    return (
        ...
        <nav className="mobile__menu">
            {user && <>
                ...
                <Link to="/basket" title="Корзина"><div className="mobile__menu__item"><Bag /></div><div className="mobile__menu__item"><h4>Корзина</h4></div></Link>
                <Link to="/favorites" title="Избранное"><div className="mobile__menu__item"><Heart /></div><div className="mobile__menu__item"><h4>Избранное</h4></div></Link>
